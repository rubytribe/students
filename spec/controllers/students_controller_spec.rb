...
describe StudentsController do
  ...
  let(:valid_attributes) { { "last_name" => "MyString", "first_name" => "MyString2", "birth_date" => "1990-12-03" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved student as @student" do
        ...
        post :create, {:student => { "last_name" => "invalid value" }}, valid_session
        assigns(:student).should be_a_new(Student)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested student" do
        ...
        Student.any_instance.should_receive(:update).with({ "last_name" => "MyString" })
        put :update, {:id => student.to_param, :student => { "last_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the student as @student" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Student.any_instance.stub(:save).and_return(false)
        put :update, {:id => student.to_param, :student => { "last_name" => "invalid value" }}, valid_session
        assigns(:student).should eq(student)
      end
